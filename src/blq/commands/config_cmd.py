...
CONFIG_SCHEMA: dict[str, dict[str, Any]] = {
    ...
    "storage.max_runs": {
        ...
        "section": "storage",
        "key": "max_runs",
        "description": "Max runs to keep per source (0 = unlimited)",
    },
    "storage.max_size_mb": {
        "type": "int",
        "default": 0,
        ...
        "section": "storage",
        "key": "max_size_mb",
        "description": "Max total output size in MB (0 = unlimited)",
    },
    "storage.prune_interval_minutes": {
        "type": "int",
        "default": 60,
        "attr": "prune_interval_minutes",
        "section": "storage",
        "key": "prune_interval_minutes",
        "description": "Minimum minutes between auto-prunes",
    },
